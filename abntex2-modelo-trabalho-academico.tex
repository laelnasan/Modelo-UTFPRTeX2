...
\documentclass[
	...
	sumario=tradicional,% default é sumario=abnt-6027-2012, 
...
% o pacote utfprtex2capatcc formata a capa para tcc. Se não for tcc não 
% precisa usar
...
\coorientador{nome do coorientador se tiver}
...
\textbf{APROVADO} de acordo com a ata da banca examinadora \textbf{N$^o$ 123} de \textbf{ \the \year }.
\end{OnehalfSpace}   
...
\begin{center}
   ...
   {\textbf{Professor} \\ Convidado 1 \\\vspace{0,5cm}}
   {\textbf{Professor} \\ Convidado 2 \\\vspace{0,5cm}}
...
\begin{resumo}
 Segundo a \cite[p.23, tradução nossa]{NBR6028:2003}, o resumo deve ressaltar o
...
% ---
\include{src/abntex2-modelo-include-comandos}
% ---
...
% ----------------------------------------------------------
% para referenciar documentos não citados
\nocite{abntex2cite}
\bibliography{src/abntex2-modelo-references}
